/**
 * GET /api/connection — report whether the current browser session is connected to Google, and if
 * so, list the GSC sites and GA4 properties the token can access for the pickers.
 *
