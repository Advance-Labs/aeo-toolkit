 ...
 *
 * Fetches the page via `@aeo/crawler` and runs the pure `extractContacts` parser
 * over its HTML. Useful for turning a prospect URL into an actual outreach target.
 */
import { z } from 'zod';
