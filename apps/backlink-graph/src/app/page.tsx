...
/**
 * Backlink Graph — the single-page 3D explorer.
 *
...
import { BacklinkGraphCanvas } from '@/components/BacklinkGraphCanvas.js';
import { DetailPanel } from '@/components/DetailPanel.js';
import { Filters, applyFilter, defaultFilter } from '@/components/Filters.js';
import type { GraphFilter } from '@/components/Filters.js';
import { StatsSidebar } from '@/components/StatsSidebar.js';
import { UrlBar } from '@/components/UrlBar.js';
import { GraphApiError, expandNode, requestGraph, streamGraph } from '@/components/graph-client.js';
import { mergeGraph, toForceGraphData } from '@/components/graph-data.js';
import type { FgNode, ForceGraphData } from '@/components/graph-data.js';
