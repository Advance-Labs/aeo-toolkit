...
const ROUTES: ReadonlyArray<{
  ...
  { path: '/tools/authority', changeFrequency: 'weekly', priority: 0.9 },
...
// 2026-09-24: bumped for /tools/authority and the regrouped tools index on the landing page.
const LAST_CONTENT_UPDATE = '2026-09-24';
