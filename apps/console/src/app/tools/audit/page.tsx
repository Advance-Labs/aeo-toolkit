...
/**
 * LLM & Technical SEO Audit tool. Re-homed from the standalone `llm-audit` app
 * into the console route segment. The shell layout provides the page `<main>`, so
 * this component renders its content inside a plain wrapper (no nested `<main>`).
 */
  ...
  return (
    <div className="flex flex-col gap-8">
      ...
      <section aria-label="Prioritized fixes" className="flex flex-col gap-3">
        <h2 className="text-lg font-semibold text-white">Prioritized fixes</h2>
      ...
      {report.templates.length > 0 ? (
        <section aria-label="Generated templates" className="flex flex-col gap-3">
          <h2 className="text-lg font-semibold text-white">Generated templates</h2>
